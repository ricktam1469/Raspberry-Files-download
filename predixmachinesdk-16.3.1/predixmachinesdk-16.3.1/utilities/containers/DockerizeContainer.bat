...
set MACHINE_PATH=
set DOCKER_HOST=
set DOCKER_FILE_NAME=Dockerfile-predixdtr-alpine
set ARCHITECTURE=x86_64
set CONTAINER_NAME=default
set TAR_NAME=
rem DO NOT CHANGE THE NAME OF THIS VARIABLE. IT TAGS PREDIX MACHINE WITH THIS NAME. THE BOOTSTRAP REQUIRES THIS.
set DOCKER_IMAGE_NAME=predixmachine
...
:DockerizeMachine
    ...
    set COMMAND=docker build -f "%DOCKER_FILE_NAME%-%ARCHITECTURE%" -t "%DOCKER_IMAGE_NAME%-%ARCHITECTURE%:%MACHINE_BUILD_VERSION%-%CONTAINER_NAME%"
