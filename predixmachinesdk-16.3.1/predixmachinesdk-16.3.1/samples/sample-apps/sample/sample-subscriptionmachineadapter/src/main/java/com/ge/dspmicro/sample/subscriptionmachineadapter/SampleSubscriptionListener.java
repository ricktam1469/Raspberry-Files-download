...
{
    private static final Logger _logger = LoggerFactory.getLogger(SampleSubscriptionListener.class);
    ...
    @Override
    public void onDataUpdate(ISubscriptionMachineAdapter sender, Map<String,String> properties,List<PDataValue> values)
    {
        for (PDataValue value : values)
        {
            _logger.info("Internal Listernal with Value:  " + value); //$NON-NLS-1$
